...
public class buyTicket_Flight_3_Future extends org.scribble.runtime.util.ScribFuture {
	public java.lang.Long pay1;
	public java.lang.Long pay2;
	public java.lang.Integer pay3;

	protected buyTicket_Flight_3_Future(CompletableFuture<org.scribble.runtime.message.ScribMessage> fut) {
		super(fut);
	}

	public buyTicket_Flight_3_Future sync() throws IOException {
